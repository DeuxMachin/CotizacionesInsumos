...
export async function GET(request: NextRequest) {
  try {
    ...
    const colWidths = [
      ...
      { wch: 20 }, // Vendedor
      { wch: 30 }, // Producto Descripción
      { wch: 10 }, // Producto Unidad
      { wch: 10 }, // Cantidad
      { wch: 15 }, // Precio Unitario
      { wch: 10 }, // Descuento %
      { wch: 15 }, // Descuento Monto
      { wch: 15 }, // Subtotal Neto
      { wch: 10 }, // IVA Aplicado
      { wch: 15 }, // Subtotal Nota Venta
      { wch: 15 }, // Descuento Líneas Nota Venta
      { wch: 15 }, // Descuento Global Nota Venta
      { wch: 15 }, // Descuento Total Nota Venta
      { wch: 15 }, // Subtotal Neto Post Desc Nota Venta
      { wch: 15 }, // IVA % Nota Venta
      { wch: 15 }, // IVA Monto Nota Venta
      { wch: 15 }, // Total Nota Venta
      { wch: 20 }, // Forma Pago
      { wch: 15 }, // Plazo Pago
      { wch: 30 }, // Observaciones Comerciales
      { wch: 25 }, // Dirección Despacho
      { wch: 15 }, // Comuna Despacho
      { wch: 15 }, // Ciudad Despacho
      { wch: 15 }, // Costo Despacho
      { wch: 15 }, // Fecha Estimada Entrega
