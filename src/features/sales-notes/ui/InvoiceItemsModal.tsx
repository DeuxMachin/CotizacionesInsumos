    ...
    <>
      ...
      <div className="fixed inset-0 z-[9999] overflow-y-auto pointer-events-none">
        <div className="flex min-h-full items-center justify-center p-4">
          <div className="relative w-full max-w-2xl bg-white rounded-lg shadow-2xl pointer-events-auto"
              ...
              <label className="flex items-center cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                <div className="relative">
                  <input
                    ...
                    onChange={toggleAll}
                    className="w-5 h-5 rounded border-2 border-gray-300 cursor-pointer text-blue-600 focus:ring-blue-500"
                  />
                </div>
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="relative mt-1">
                        ...
                        />
                        {isSelected && (
                          <FiCheck className="absolute inset-0 w-5 h-5 pointer-events-none text-blue-600" />
                        )}
                      </div>
                          ...
                          <div className="mt-3 pt-3 border-t border-gray-200">
                            <div className="flex items-center gap-3">
                              <div className="flex items-center gap-2">
                                <label className="text-xs text-gray-600 mr-2">Cantidad a facturar:</label>
                                <button
                                  onClick={() => updateQuantity(item.id, currentQuantity - 1)}
                                  disabled={currentQuantity <= alreadyInvoiced}
                                  className="w-8 h-8 flex items-center justify-center border border-gray-300 rounded-lg hover:bg-gray-50 disabled:opacity-30 disabled:cursor-not-allowed text-lg font-bold"
                                ...
                                <input
                                  ...
                                  className="w-16 px-2 py-1 border border-gray-300 rounded-lg text-center text-sm font-medium focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                />
                                <button
                                  onClick={() => updateQuantity(item.id, currentQuantity + 1)}
          ...
          <div className="px-6 py-4 border-t border-gray-200 bg-gray-50 flex justify-end space-x-3">
            <button
              ...
              className="px-4 py-2 rounded-lg transition-colors border border-gray-300 bg-white text-gray-700 hover:bg-gray-50"
            >
              Cancelar
            </button>
            <button
              ...
              disabled={isSubmitting}
              className="px-4 py-2 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed bg-blue-600 text-white hover:bg-blue-700"
            >
